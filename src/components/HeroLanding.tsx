        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          >
            ...
            <div className="bg-white border-4 border-black p-4 sm:p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] sm:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] rounded-2xl">
              <p className="text-base sm:text-lg lg:text-xl font-bold leading-relaxed">
                From ancient ciphers to <span className="bg-yellow-300 px-1 sm:px-2 py-1 border-2 border-black rounded-lg">post-quantum encryption</span> —
                explore the full spectrum of cryptography through interactive visualizations,
                live playgrounds, and step-by-step animated explainers.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              {[
                { label: 'Classical', color: 'bg-yellow-300' },
                { label: 'Symmetric', color: 'bg-orange-300' },
                { label: 'Asymmetric', color: 'bg-purple-300' },
                { label: 'Post-Quantum', color: 'bg-rose-300' },
                { label: 'Quantum', color: 'bg-sky-300' },
              ].map(({ label, color }) => (
                <span key={label} className={`${color} border-2 border-black px-3 py-1 rounded-xl font-black text-xs uppercase shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]`}>
                  {label}
                </span>
              ))}
            </div>
            ...
            <div className="flex items-center gap-3 sm:gap-6 flex-wrap">
              <div className="bg-yellow-300 border-4 border-black p-3 sm:p-4 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] rounded-2xl">
                ...
                <div className="text-xs sm:text-sm font-bold uppercase">Cipher Schemes</div>
              </div>
          ...
          >
            ...
            <motion.div
              ...
              className="absolute bottom-4 sm:bottom-10 right-4 sm:right-10 w-16 sm:w-24 lg:w-32 h-16 sm:h-24 lg:h-32 bg-purple-500 border-4 border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] lg:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] rounded-2xl"
            ...
            <motion.div
              ...
              className="absolute top-1/3 right-1/4 w-20 sm:w-32 lg:w-40 h-12 sm:h-18 lg:h-24 bg-orange-400 border-4 border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] lg:shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] -rotate-12 rounded-2xl"
            >
